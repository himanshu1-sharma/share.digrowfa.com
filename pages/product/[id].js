                        ...
                        <div className='col-xl-6 col-lg-6'>
                            <div className={styles.shareBoxBg}>
                                <div className={styles.shareBox}>
                                    ...
                                    <div className='sharePageProductSlider'>
                                        <Swiper
                                            slidesPerView={"auto"}
                                            spaceBetween={10}
                                        ...
                                        >
                                            {cardData?.image1 ?
                                                ...
                                                <SwiperSlide>
                                                    <div className={styles.sharePageProductImgBox} style={{ backgroundImage: `url(${cardData?.image1?.location})` }}></div>
                                                </SwiperSlide>
                                            ...
                                            {cardData?.image2 ?
                                                ...
                                                <SwiperSlide>
                                                    <div className={styles.sharePageProductImgBox} style={{ backgroundImage: `url(${cardData?.image2?.location})` }}></div>
                                                </SwiperSlide>
                                            ...
                                            {cardData?.image3 ?
                                                ...
                                                <SwiperSlide>
                                                    <div className={styles.sharePageProductImgBox} style={{ backgroundImage: `url(${cardData?.image3?.location})` }}></div>
                                                </SwiperSlide>
                                            ...
                                            {cardData?.image4 ?
                                                ...
                                                <SwiperSlide>
                                                    <div className={styles.sharePageProductImgBox} style={{ backgroundImage: `url(${cardData?.image4?.location})` }}></div>
                                                </SwiperSlide>
                                            ...
                                            {cardData?.image5 ?
                                                ...
                                                <SwiperSlide>
                                                    <div className={styles.sharePageProductImgBox} style={{ backgroundImage: `url(${cardData?.image5?.location})` }}></div>
                                                </SwiperSlide>
